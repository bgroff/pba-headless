...
import { Bars3CenterLeftIcon, Bars4Icon, ClockIcon, HomeIcon, XMarkIcon, AdjustmentsHorizontalIcon } from '@heroicons/react/24/outline'
import {
  ChevronRightIcon,
  ChevronUpDownIcon,
...
const navigation = [
  { name: 'Bakeries', href: '#', icon: HomeIcon, current: true },
  // { name: 'Connections', href: '#', icon: AdjustmentsHorizontalIcon, current: false },
]
const teams = [
